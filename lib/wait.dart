...
class ShowModelPage extends StatefulWidget {
  const ShowModelPage({super.key});

  @override
  State<ShowModelPage> createState() => _ShowModelPageState();
}

class _ShowModelPageState extends State<ShowModelPage> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Flutter3DViewer(
          ...
          // src: 'assets/model/toothless_dance.glb',
          src: 'assets/model/toothless_dance.gltf',
